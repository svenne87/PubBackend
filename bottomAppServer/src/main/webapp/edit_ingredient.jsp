...
<body>
	<h1>Edit this Ingredient</h1>
    <br>
    <h2>Edit: ${ingredient.getName()}</h2>
    <c:url var="editUrl" value="/edit_ingredient"/>	    
    <form:form method="PUT" action="${editUrl}" commandName="ingredient">
